...
file_dir = ''
# file_dir = '/home/mayank_sati/codebase/git/AI/Annotation_tool_V3/system/Labels/2019-09-27-14-39-41_test_scaled'
check_path = "./Labels/farm_2_images2_scaled"
...
for files in filelist:
    ...
    with open(files) as f:
        for (i, line) in enumerate(f):
            ...
            if obj_id == '5011':
                continue
            # if img_name is not in
            # '/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/valid_farm/1569609976158666560_301403.375321_4704812.57923.jpg'
            file_exist_path = check_path + "/" + img_name
            if not os.path.exists(file_exist_path):
                continue
...
csv_name = file_dir + "_eval_farm.csv"
