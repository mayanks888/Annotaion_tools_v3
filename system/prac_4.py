...
class LabelTool():
    ...
    def loadDir(self, dbg=False):
        ...
        if not dbg:
            ...
            # s = r'/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/2019-09-27-14-36-44'
        ...
        if os.path.exists(self.labelfilename):
            with open(self.labelfilename) as f:
                for (i, line) in enumerate(f):
                    ...
                    tmpId = self.mainPanel.create_rectangle(tx0, ty0, tx1, ty1, width=2,
