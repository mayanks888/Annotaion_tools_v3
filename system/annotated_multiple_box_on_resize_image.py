...
root = "/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/test_output"
...
csv_path = '/home/mayank_sati/codebase/git/AI/Annotation_tool_V3/system/Labels/2019-09-27-14-39-41_test.csv'
...
for da1 in sorted(mygroup.keys()):
    ...
    for read_index in index:
        print(index)
        top = (y[read_index][0] / 2, y[read_index][3] / 2)
        bottom = (y[read_index][2] / 2, y[read_index][1] / 2)
