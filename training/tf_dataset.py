            ...
            for dd in range(self.delta):
                ...
                if gtType < USE_NETWORK_PROB:
                    ...
                    if dd < self.delta - 1:
                        ...
                        networkOuts, s1, s2 = self.sess.run([self.networkOutputs, self.state1, self.state2],
                                                            feed_dict=feed_dict)
                ...
                if self.debug:
                    ...
                    subplot = drawing.subplot(plots, 2, 2, outputWidth=OUTPUT_WIDTH, outputHeight=OUTPUT_HEIGHT,
                                              border=5)
